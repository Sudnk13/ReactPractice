        ...
        <div className="card px-4">
            <div className="card-body text-start">
                <div className="col-12 d-flex align-items-center justify-content-center">
                    <div className="card-title h5 text-center pe-2">
                        Your Application Rejected
                    </div>
                    <img src="./img/sad but relieved face.svg" alt=""/>
                </div>
                ...
                <div className="row border p-3 my-4 rounded">
                    <div className="col">
                        ...
                        <div className="card-text">Aadhar based document signing by all three agencies through Leegality or
                            Docusign. In this each upon confirming gets
                            link where he enters Aadhar number and then OTP to sign the document. After that process
                            where insured pays the premium
                            and enter transaction details and then NBFC pays the amount in loan account and confirms the
                            details here. Both payment
                            details are sent to all three parties
                        </div>
                    </div>
                </div>
